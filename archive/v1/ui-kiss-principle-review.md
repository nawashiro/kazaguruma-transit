> **Status:** Historical — Review record（履歴・レビュー記録）
> **レビュー時点:** 2026-07-14
> **対象commit:** 原文に明記なし
> **Unverified scope:** ルビ外部ライブラリの実行契約、Nostr relayの実測、PDFの実際のレンダリング結果。
> **Scope:** 現行仕様・開発手順ではありません。以下のリンクと行番号はレビュー時点の参照であり、削除・移動後のコンポーネントを現行入口として案内しません。
...
対象: [`settings/page.tsx`](../../src/app/settings/page.tsx#L429-L448)、[`edit/page.tsx`](../../src/app/discussions/[naddr]/edit/page.tsx#L1057-L1077)、`RateLimitModal.tsx`、`LocationDetailModal.tsx`
