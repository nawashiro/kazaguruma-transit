...
[NIP-22](https://github.com/nostr-protocol/nips/blob/master/NIP-22) kind 1111 events SHOULD be used for text notes posted to a community, with the `A` tag always scoped to the community definition.
...
Moderators MAY request deletion of their approval of a post at any time using [NIP-09 event deletion requests](https://github.com/nostr-protocol/nips/blob/master/09.md).
