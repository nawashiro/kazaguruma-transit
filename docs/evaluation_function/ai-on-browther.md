...
| e-Stat        | Data from Statistics Dashboard ([https://dashboard.e-stat.go.jp/en/](https://dashboard.e-stat.go.jp/en/)) |
| Eurostat      | Data from Eurostat ([https://ec.europa.eu/eurostat](https://ec.europa.eu/eurostat))                       |
| Pokémon       | Pokémon data ([https://pokeapi.co/](https://pokeapi.co/))                                                 |
