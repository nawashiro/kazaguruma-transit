...
代表的コメント識別では、Network Algorithm (Mehta & Patel, 1983) と mid-P 値アプローチを組み合わせた手法を採用している。この組み合わせにより、計算効率性と統計的妥当性の両立を実現している。
...
$$\text{mid-P} = P(X < \text{observed}) + 0.5 \times P(X = \text{observed})$$
