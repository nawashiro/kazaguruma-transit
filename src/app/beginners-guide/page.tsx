    ...
    <div className="container">
      ...
      <main>
        ...
        <div className="max-w-md mx-auto space-y-4">
          <section id="what-is" className="card bg-base-100 shadow-md">
            <div className="card-body">
          ...
          <section id="how-to-ride" className="card bg-base-100 shadow-md">
            <div className="card-body">
          ...
          <section id="about-site" className="card bg-base-100 shadow-md">
            <div className="card-body">
          ...
          <section id="about-me" className="card bg-base-100 shadow-md">
            <div className="card-body">
          ...
          <section id="payment" className="card bg-base-100 shadow-md">
            <div className="card-body">
