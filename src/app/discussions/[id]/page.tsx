...
const busStops = [
  { route: 'A線', stops: ['千代田区役所', '東日本銀行神田支店', '千代田保健所'] },
          ...
          <div className="space-y-6">
            <div>
              ...
              {topPosts.length > 0 ? (
                    ...
                    <div key={post.id} className="card bg-base-100 shadow-sm border border-gray-200 dark:border-gray-700">
                      <div className="card-body p-4">
                        <div className="flex items-start justify-between mb-2">
                          ...
                          <div className="text-right">
                            <span className="text-sm text-gray-500">
                              スコア: {post.evaluationStats.score.toFixed(2)}
                            </span>
                          </div>
                        </div>
                        {post.busStopTag && (
                        ...
                        <div className="text-xs text-gray-500 mt-2">
                          ...
                          👍 {post.evaluationStats.positive} 👎 {post.evaluationStats.negative}
                        </div>
                      </div>
                    </div>
                  ))}
                ...
                <p className="text-gray-600 dark:text-gray-400">承認された投稿がまだありません。</p>
              )}
            </div>
