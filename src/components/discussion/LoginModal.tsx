...
function findKeyboardTargetMode(
  currentMode: LoginMode,
  key: string
): LoginMode | null {
  if (key === "ArrowLeft" || key === "ArrowRight") {
    return currentMode === "create" ? "login" : "create";
  }
  return null;
}
...
export function LoginModal({ isOpen, onClose, reason }: LoginModalProps) {
  ...
  const handleTabKeyDown = (
    ...
    const targetMode = findKeyboardTargetMode(currentMode, event.key);
    if (!targetMode) return;

    event.preventDefault();
    setMode(targetMode);
    const targetTabRef =
      targetMode === "create" ? createTabRef : loginTabRef;
  ...
  return (
    <dialog
      ...
      aria-labelledby={`login-modal-${mode}-title`}
      aria-describedby={`login-modal-${mode}-description`}
    >
      ...
      <div className="modal-box bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-md mx-4">
        ...
        <div className="flex justify-between items-center mb-4">
          ...
          >
            <button
              ...
              aria-controls="login-modal-create-panel"
            ...
            <button
              ...
              aria-controls="login-modal-login-panel"
        ...
        <div
          id="login-modal-create-panel"
          role="tabpanel"
          aria-labelledby="login-modal-create-tab"
          tabIndex={0}
          hidden={mode !== "create"}
        >
          <div className="mb-4" id="login-modal-create-description">
            <h2
              id="login-modal-create-title"
        ...
        <div
          id="login-modal-login-panel"
          role="tabpanel"
          aria-labelledby="login-modal-login-tab"
          tabIndex={0}
          hidden={mode !== "login"}
        >
          <div className="mb-4" id="login-modal-login-description">
            <h2
              id="login-modal-login-title"
              className="text-xl font-bold mb-4 ruby-text"
            >
              ログイン
            </h2>
